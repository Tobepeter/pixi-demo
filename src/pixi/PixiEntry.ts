...
import { Application, Color, Container, Ticker } from 'pixi.js'
...
class PixiEntry {
  ...
  async init() {
    ...
    // NOTE: 不能识别为行内元素，不然底部固定多一个空白，逼死强迫症
    ...
    this.root = root
    root.name = 'centerRoot'
    this.interactRoot.addChild(root)
